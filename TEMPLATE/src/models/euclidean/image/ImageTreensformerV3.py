...
from src.models.euclidean.base.Treensformer.TreensformerV3 import TreensformerBlockV3

# Add these imports for visualization
import networkx as nx
import matplotlib.pyplot as plt

class ImageTreensformerV3(BaseModule):
    def __init__(
        self,
        ...
        super(ImageTreensformerV3, self).__init__(input_shape=input_shape, output_shape=output_shape)
