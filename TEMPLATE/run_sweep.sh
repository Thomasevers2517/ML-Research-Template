...
for i in $@; do
    echo "running command: CUDA_VISIBLE_DEVICES=$i wandb agent thomasevers9/ML-Research-Template-TEMPLATE/$sweep_id "

    CUDA_VISIBLE_DEVICES=$i wandb agent thomasevers9/ML-Research-Template-TEMPLATE/$sweep_id
